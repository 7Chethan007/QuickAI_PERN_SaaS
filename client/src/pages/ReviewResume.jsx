...
const ReviewResume = () => {
    const [input, setInput] = useState('') // input is the file object
            ...
            const { data } = await axios.post('/api/ai/review-resume', formData,
                { 
                    headers: { 
                        ...
                        // Important: axios sets Content-Type to multipart/form-data automatically for FormData
                    } 
                }
            );
    ...
    text-slate-700'>
        ...
        border-gray-200'>
            ...
            rounded-md border border-gray-300 text-gray-300'
                />
            ...
            flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
...

                {
                    !content ? (
                        ...
                        <div className='mt-4 overflow-y-scroll text-sm text-slate-600'>
                            <div className='whitespace-pre-wrap reset-tw'>
